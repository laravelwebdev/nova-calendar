...
namespace Laravelwebdev\NovaCalendar\Http\Controllers;
...
class CalendarController extends BaseController
{
    ...
    const API_PATH_PREFIX = '/nova-vendor/laravelwebdev/nova-calendar/';
    ...
    public function __construct()
    {
        ...
        foreach(config('nova-calendar', []) as $calendarKey => $calendarConfig)
        {
            ...
            // Laravelwebdev\NovaCalendar\NovaCalendar does all sorts of checks on initiation
