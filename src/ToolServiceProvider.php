...
namespace Laravelwebdev\NovaCalendar;
...
use Laravelwebdev\NovaCalendar\Http\Middleware\Authorize;
use Laravelwebdev\NovaCalendar\Console\Commands\CreateDefaultCalendarDataProvider;
...
class ToolServiceProvider extends ServiceProvider
{
   ...
   > Updating the config file for v2.0 is trivial, take a look at the Upgrade Guide at https://laravelwebdev.github.io\n\n";
            ...
            else if(is_array($calendarConfig))
            {
                ...
                else
                {
                    ...
                    Route::middleware(['nova', Authorize::class])
                        ->prefix('nova-vendor/laravelwebdev/nova-calendar/' .$calendarConfig['uri'])
