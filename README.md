...
![The design of the calendar in both clear and dark mode](https://github.com/laravelwebdev/nova-calendar/blob/main/resources/doc/screenshot.jpg?raw=true)
...
For help implementing and using the calendar, take a look at the [documentation](https://laravelwebdev.github.io/nova-calendar).

# Upgrade
Version 2.0 of this package was released on June 7th, 2023.

There's an [Upgrade Guide](https://laravelwebdev.github.io/nova-calendar/upgrading.html) for users of v1.x. You shouldn't need more than 15 minutes to upgrade.
...
Please create or upvote [feature request discussions](https://github.com/laravelwebdev/nova-calendar/discussions/categories/ideas-feature-requests) in the GitHub repo for the features you think would be most valuable to have.
...
### v2.0
- Adds support for [multiple instances](https://laravelwebdev.github.io/nova-calendar/adding-more-calendar-views.html) of the calendar, each with their own calendar data provider and configuration
- Adds support for [Event filters](https://laravelwebdev.github.io/nova-calendar/event-filters.html), allowing the end user to show different subsets of events within a calendar
...
- Adds support for [custom event generators](https://laravelwebdev.github.io/nova-calendar/custom-event-generators.html) to define your own mapping from Nova resource to calendar event(s)
- For developers of this package: added first set of unit tests

### v1.5
- The calendar timezone can now be [customized](https://laravelwebdev.github.io/nova-calendar/customizing-the-calendar.html)
