/* * © Copyright 2022 · Willem Vervuurt, Studio Delfuego * * You can modify,
use and distribute this package under one of two licenses: * 1. GNU AGPLv3 * 2.
A perpetual, non-revocable and 100% free (as in beer) do-what-you-want * license
that allows both non-commercial and commercial use, under conditions. * See
LICENSE.md for details. * * (it boils down to: do what you want as long as
you're building and/or * using calendar views, but don't embed this package or a
modified version * of it in free or paid-for software libraries and packages
aimed at developers). */
  ...
  <div>
    ...
    <div id="nc-control">
      ...
      <div class="right-items">
              ...
              <ScrollWrap :height="350" class="bg-white dark:bg-gray-900">
                ...
                >
                  <div class="p-3 text-center">
                    ...
                    >
                      <option
                        v-for="(monthLabel, monthNum) in $data.monthLabels"
                        :value="monthNum"
                      >
                        {{ monthLabel }}
                      </option>
        ...
        >
          <DropdownTrigger style="cursor: pointer">
            <Button variant="action" icon="plus"> </Button>
          </DropdownTrigger>
          <template #menu>
              ...
              <ScrollWrap :height="350" class="bg-white dark:bg-gray-900">
                ...
                >
                  <div>
                    <template
                      v-for="(
                        resourcesLabel, resourcesKey
                      ) in $data.availableResources"
                    >
            ...
            <DropdownMenu width="260">
              <ScrollWrap :height="350" class="bg-white dark:bg-gray-900">
                ...
                >
                  ...
                  <div>
                    <template
                      v-for="(filterLabel, filterKey) in $data.availableFilters"
                    >
                      <button
                        class="py-2 w-full block dark:bg-gray-800 dark:hover:bg-gray-700 hover:bg-gray-200"
                    ...
                    >
                      ...
                      <div class="badges noscrollbar">
                        <span
                          ...
                          ><span class="badge" v-html="badge"></span
                        ></span>
                      </div>
                      <div class="content noscrollbar">
                        <template
                          v-if="event.startsEvent && event.options.displayTime"
                        >
                      ...
                      >
                        ...
                        <div class="content noscrollbar">
                          <template v-if="event.options.displayTime">
                            <span class="time" v-if="event.endTime"
...
export default {
  ...
  methods: {
    ...
    reload(isInitRequest = false) {
      ...
      let apiUrl =
        "/nova-vendor/laravelwebdev/nova-calendar" +
        this.calendarUrl() +
        "/month?y=" +
        vue.year +
        "&m=" +
    ...
    storageKey() {
      return "laravelwebdev-nova-calendar-" + this.calendarUrl();
    },
